            ...
            <div style={{ backgroundColor: "#17171e" }}>
                <Box bg="#17171e">
                    ...
                    >
                        ...
                        <Text size="xl" fw={700} c="white">JOINER</Text>
                    </Flex>

                    <Text size="70px" fw={600} c="white" ta="center" mt={20}>
                        Audio Cutter
                    </Text>
                    <Text size="35px" fw={380} c="white" ta="center" mt={27}>
                    ...
                    <Box justify="center" align="center" mt={40}>
                        <button
                            style={{
                                ...
                                width: "250px",
                                padding: "10px",
                                border: "2px rgb(100 92 192) solid",
                                backgroundColor: "#17171e",
                            }}
                        >
                            <Text size="25px" c="white" p={5}>
                                Browse My File
                            </Text>
                        </button>
                    </Box>
                    ...
                    <Container size="2xl" p={50} style={{ zIndex: 100 }}>
                        <SimpleGrid cols={1}>
                            <div>
                                <Text size="50px" fw={380} c="white" mt={27} mr="auto">
                                    How to cut audio
                                </Text>
                            </div>
                            <div
                                style={{
                                    borderLeft: '5px ridge rgb(100 92 192)',
                                    backgroundColor: "rgba(207, 202, 202, 0.1)",
                                    backdropFilter: "blur(10px)",
                                    padding: "20px",
                                    marginTop: "40px",
                                }}
                            >
                                <Text size="35px" c="white" fw={35}>
                            ...
                            <div>
                                <Flex direction="row" wrap="wrap" gap="lg" mt={40}>
                                    <CiLock size={35} color="white" />
                                    <Text size="35px" c="white" fw={55}>
